...
document.addEventListener("DOMContentLoaded", function() {
    ...
    var firstImageSrc = "static/img/off.png";
    var secondImageSrc = "static/img/on.png";
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    var firstImageSrc = "static/img/login.png";
    var secondImageSrc = "static/img/logout.png";
    var currentImage = firstImageSrc;
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    var firstImageSrc = "static/img/soleil.png";
    var secondImageSrc = "static/img/lune.png";
    var currentImage = firstImageSrc;
